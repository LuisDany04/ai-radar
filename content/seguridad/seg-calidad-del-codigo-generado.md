...
**No hay un experimento controlado grande e independiente específico de seguridad.** El estándar más alto de evidencia —un ensayo aleatorizado con desarrolladores reales resolviendo tareas reales, sin financiamiento de un proveedor con interés en el resultado— existe para productividad (el estudio de METR de julio de 2025, con 16 desarrolladores experimentados y 246 tareas reales, que encontró que las herramientas de IA los hacían 19% más lentos pese a que ellos creían haber sido más rápidos) pero no tiene un equivalente de ese rigor centrado en seguridad. El estudio de Stanford es lo más cercano, y ya tiene tres años y usa un modelo discontinuado.
